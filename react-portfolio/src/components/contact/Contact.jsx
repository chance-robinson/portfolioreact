...
const Contact = () => {
  ...
  return (
    <section id='contact'>
      ...
      <h2>Contact Me</h2>
      <Modal isOpen={modalSuccess} onRequestClose={() => setModalSuccess(false)} >
        <p>You're form was submitted</p>
        <button onClick={() => setModalSuccess(false)}>Close</button>
      </Modal>
      <Modal isOpen={modalError} onRequestClose={() => setModalError(false)}>
